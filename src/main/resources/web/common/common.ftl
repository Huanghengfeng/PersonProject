...
<link rel="stylesheet" href="${request.contextPath}/css/jquery-confirm.min.css">
...
<script src="${request.contextPath}/js/fileinput.min.js"></script>
<script src="${request.contextPath}/js/fileinput_locale_zh.js"></script>
